...
class Gesture_System:
    def __init__(self,stop_event):
        ...
        medical_images=os.path.abspath('Medical_Images')
        emergency=os.path.abspath('Emergency')
        patientsRecords=os.path.abspath('patientsRecords')
        ...
        while not stop_event.is_set():
            ...
            if len(lmlist)!=0:
                ...
                if fingers[0] == 0 and fingers[1] == 0 and fingers[2] == 0 and fingers[3] == 1 and fingers[4] == 1 and time_diff.seconds % 60 >1 :
                    last_opened_time=time_now
                    subprocess.Popen(f'explorer "{medical_images}"')
                
                if fingers[0] == 0 and fingers[1] == 0 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1 and time_diff.seconds % 60 >1 :
                    last_opened_time=time_now
                    subprocess.Popen(f'explorer "{emergency}"')

                if fingers[0] == 0 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1 and time_diff.seconds % 60 >1 :
                    last_opened_time=time_now
                    subprocess.Popen(f'explorer "{patientsRecords}"')
